/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 01ed5739957c7836935fb6ca3378d804)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		R2_BUCKET_NAME: "cf-hr-template-prod";
	...
	interface Env {
		...
		LOG_REDACT_FIELDS: "authorization,cookie,set-cookie,password,token,secret,api-key,x-api-key";
		R2_ACCOUNT_ID: "YOUR_R2_ACCOUNT_ID";
		R2_BUCKET_NAME: "cf-hr-template-prod" | "cf-hr-template-dev";
		R2_PRESIGNED_URL_TTL_SECONDS: "900";
		BETTER_AUTH_SECRET: string;
		R2_ACCESS_KEY_ID: string;
		R2_SECRET_ACCESS_KEY: string;
