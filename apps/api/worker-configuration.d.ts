/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 395676bc46a65b4452cf8f8612029f23)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		R2_BUCKET_NAME: "cf-hnr-template-prod";
	...
	interface Env {
		...
		LOG_REDACT_FIELDS: "authorization,cookie,set-cookie,password,token,secret,api-key,x-api-key";
		R2_ACCOUNT_ID: "YOUR_R2_ACCOUNT_ID";
		R2_BUCKET_NAME: "cf-hnr-template-prod" | "cf-hnr-template-dev";
		R2_PRESIGNED_URL_TTL_SECONDS: "900";
		BETTER_AUTH_SECRET: string;
		R2_ACCESS_KEY_ID: string;
		R2_SECRET_ACCESS_KEY: string;
