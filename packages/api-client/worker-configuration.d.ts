/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: e89cca20efc2ce0e5e5f980a48a075c4)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		LOG_REDACT_FIELDS: "authorization,cookie,set-cookie,password,token,secret,api-key,x-api-key";
		R2_ACCOUNT_ID: "35ade4713beefb2c7f971921950b34c2";
		R2_BUCKET_NAME: "cms-prod" | "cms-dev";
		R2_PRESIGNED_URL_TTL_SECONDS: "900";
		BETTER_AUTH_SECRET: string;
		R2_ACCESS_KEY_ID: string;
		R2_SECRET_ACCESS_KEY: string;
